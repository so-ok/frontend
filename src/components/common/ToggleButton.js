...
const Transition = 'w-6 h-6 transition ease-in duration-300';
    ...
    <Container>
      <ToggleContainer>
        ...
        <Selected htmlFor='list' className='peer-checked/list:bg-rose-400 peer-checked/list:shadow-md'>
          <List props={Transition} color={listStyle === 'list' ? '#e2e8f0' : '#475569'}></List>
        </Selected>
        ...
        <Selected htmlFor='block' className='peer-checked/block:bg-rose-400 peer-checked/block:shadow-md'>
          <Block props={Transition} color={listStyle === 'block' ? '#e2e8f0' : '#475569'}></Block>
        </Selected>
      </ToggleContainer>
    </Container>
  );
